<template>
  <div>
    <a-scene renderer="colorManagement: true">
      ...
      <a-gltf-model src="#classroom"></a-gltf-model>
    </a-scene>
  </div>
</template>
